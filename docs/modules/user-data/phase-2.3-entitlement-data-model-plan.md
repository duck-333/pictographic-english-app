...
> 历史规划说明：本文的“分享奖励 10 次”及示例到期日期用于说明多来源额度和 FIFO 消费，不是现行产品规则。自 2026-09-23 起，现行规则以 `docs/CONTENT_ACCESS_POLICY.md` F 节为准：有效邀请奖励为 `SHARE_REWARD +30`，自发放之日起一年有效，每位邀请人最多成功获得 5 次。
