...
> 历史规划说明：本文保留 Phase 2.3 早期模型设计语境，其中“邀请奖励例如 +5”等数值仅为字段示例，不是现行产品规则。自 2026-09-23 起，现行规则以 `docs/CONTENT_ACCESS_POLICY.md` F 节为准：功能名称为“邀请新用户注册成功得30次”，有效邀请新人首次完成手机号快捷注册后，邀请人获得一年有效的 `SHARE_REWARD +30`，累计最多 5 次。
